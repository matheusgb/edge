// Comando negative roda os testes negativos da borda.
//
...
// diz nada sobre o que a borda recusa.
//
...
func main() {
	...
	runner := &runner{client: client, edge: strings.TrimSuffix(*edgeURL, "/")}
...
func (r *runner) metodoNaoPermitido(ctx context.Context, tag int64) Vetor {
	...
	if err != nil {
		return erroDeSetup("metodo-nao-permitido", "borda", err)
	}
...
func (r *runner) corpoGrande(ctx context.Context, tag int64) Vetor {
	...
	if err != nil {
		return erroDeSetup("corpo-grande", "borda", err)
	}
...
func (r *runner) caminhoCodificadoNaoDuplicaEntrada(ctx context.Context, tag int64) Vetor {
	...
	// decodificar e limpar. Se a borda e o validador normalizarem igual, isto é
...
func (r *runner) tokenNaoChegaNaOrigem(ctx context.Context) Vetor {
	...
	return veredito(Vetor{
		...
		Categoria: "token",
		Descricao: "a borda encaminha o caminho sem a query onde o token viaja",
...
func render(vetores []Vetor, falhas int) string {
	...
	fmt.Fprintf(&b, "# Resumo: testes negativos da borda\n\n")
