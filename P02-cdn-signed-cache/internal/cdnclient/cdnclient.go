// Package cdnclient é o cliente que os experimentos usam para falar com o lab.
//
...
// não o serviço que a CDN consulta.
package cdnclient
...
func New(cdnURL, tokendURL string, concurrency int) *Client {
	if concurrency < 8 {
		concurrency = 8
	}
...
// o cliente fez à CDN, quantas realmente custaram trabalho à origem?
...
// SignedURL devolve a URL completa, já apontando para a CDN.
