...
//     objeto ainda não está no cache da CDN, sem precisar limpar o cache.
//
...
// que a CDN erre a normalização do caminho, um nome com barra, ".." ou byte
...
// CDN e o validador normalizam o caminho antes, mas a origem é a última linha
...
// o mesmo valor, em qualquer réplica da origem. Isso é o que permite à CDN
