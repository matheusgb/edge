...
type Origin struct {
	...
	// Responde à pergunta central do projeto: quanto tráfego a CDN absorveu?
	...
	// Se isso subir, ou a CDN está mal configurada, ou alguém achou a origem.
...
func NewOrigin() *Origin {
	...
	m.AuthFailures = prometheus.NewCounterVec(prometheus.CounterOpts{
		Name: "origin_cdn_auth_failures_total",
		Help: "Requisições sem o segredo compartilhado da CDN, por rota.",
	}, []string{"route"})
