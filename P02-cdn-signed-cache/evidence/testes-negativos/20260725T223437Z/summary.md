...
| host-desconhecido | poisoning | Host inventado, tentando criar uma entrada de cache paralela | conexão encerrada ou 4xx | erro de transporte: Get "http://127.0.0.1:8080/objects/neg-1KiB-1785018875-host.bin?(token omitido)": EOF | passou |
...
| token-nao-chega-na-origem | token | a CDN encaminha o caminho sem a query onde o token viaja | URI na origem sem sig= nem kid= | 200 | passou |
