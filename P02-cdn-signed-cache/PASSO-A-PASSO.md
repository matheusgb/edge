...
**`cdn_log_token_leaks_total` deve ser zero para sempre.** O exportador vigia o
...
2. pede um token por objeto, antes de medir, para que o tempo medido seja o da
   CDN e não o do serviço de token;
...
quatro vezes mais chamadas à origem e exatamente os mesmos bytes, porque as 631
...
[test/cdn_integration_test.go](test/cdn_integration_test.go) sobe o Compose pelo
