...
```text
edge-a	p03-edge:local	Up 10 minutes
edge-b	p03-edge:local	Up 10 minutes
edge-c	p03-edge:local	Up 10 minutes
grafana	grafana/grafana:12.3.0	Up 2 hours
loki	grafana/loki:3.5.7	Up 2 hours
origin	p03-edge:local	Up 10 minutes
prometheus	prom/prometheus:v3.6.0	Up 2 hours
promtail	grafana/promtail:3.5.7	Up 2 hours
router	p03-edge:local	Up 10 minutes
